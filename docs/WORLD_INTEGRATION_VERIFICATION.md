...
Base: Tilth 7991a5d. Implementation commits: 49ffd4c, 7b72fef, cd37f9c, 3b4bad9.

- `npm test`: 86 Node tests and 5 Vitest tests pass. No upstream service is called by the suite.
