...
export function createLifeWorld(): LifeState {
  return { id: crypto.randomUUID(), version: 0, elapsed: 0, day: 1, hour: 16, minute: 20, speed: 1, theme: 'loft', title: 'A little life', width: 12, depth: 10, provider: { ...OFFLINE_PROVIDER }, events: [],
    ...
    objects: [object('fridge', 'Kitchen', 1, 1.1, .9, .9, 1, 2.05, ['eat']), object('coffee', 'Coffee station', 2.6, 1.1, .8, .8, 2.6, 2, ['coffee']), object('table', 'Dining table', 5.7, 2, 1.9, 1.2, 5.7, 3, ['eat']), object('bed', 'Cozy bed', 10.3, 1.6, 2.1, 2.2, 8.8, 1.6, ['sleep']), object('sofa', 'Cloud sofa', 2, 7.9, 2.8, 1.1, 2, 6.8, ['relax']), object('bookshelf', 'Bookshelf', .8, 5, .7, 1.8, 1.7, 5, ['read']), object('plant', 'Window garden', 10.9, 8.7, .7, .7, 10.2, 8.7, ['water']), object('easel', 'Studio easel', 9.8, 5.6, .9, .8, 9.8, 6.55, ['paint'])] };
}
